            ...
            < Stack height="100%" width={"100%"} >
                ...
                < Box px={1.5} pb={3} height={"100%"} width={"100%"} sx={{ overflowY: "scroll", position: "relative" }}>
                    ...
                    <Stack spacing={2}>
                        ...
                        <Stack py={1.5} spacing={2} sx={{ position: "sticky", top: "0", backgroundColor: theme.palette.background.default }} >
                            ...
                            <Stack width={"100%"} direction={"row"} gap={1} justifyContent={"center"} alignItems={"center"}>
                                {
                                    [1, 2, 3].map(item => (
                                        <Box width={100} >
                                            <IconButton>
                                                <img style={{ width: "100%", objectFit: "cover" }} src={faker.image.people()} alt={faker.name.fullName()} />
                                            </IconButton>
                                        </Box>
                                    ))
                                }
                        ...
                        <Stack spacing={2} >
                            ...
                            <Stack direction="row" alignItems={"center"} gap={2}  >
                                ...
                                {/* name and members */}
                                <Stack  >
                                    <Typography variant={"subtitle2"}>{faker.name.middleName()}</Typography>
